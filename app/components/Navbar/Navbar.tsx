          ...
          <div className="flex items-center gap-4">
            ...
            >
              <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0">
                <li>
                  <Link className="block py-2" href="../../Views/Rent">
                    <h1 className="font-playfair text-white text-base px-0 ">Alquilar</h1>
                  </Link>
                </li>
                <li>
                  <Link className="block py-2 text-black rounded md:bg-transparent" href="../../Views/Buy">
                    <h1 className="font-playfair text-white text-base px-0 ">Comprar</h1>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    <h1 className="font-playfair text-white text-base px-0">Publicar Inmueble</h1>
                  </Link>
                </li>
                <li className="block py-2 pl-2 pr-4 text-gray-900 rounded-full hover:bg-yellow-400">
                  {renderLoginButton()}
                </li>
              </ul>
            </div>

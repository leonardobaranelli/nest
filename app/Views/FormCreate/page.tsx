...
export default function Formulario() {
  ...
  const disable = (errors: FieldErrors): boolean => {
  ...
  async function handleImages(files: File[]): Promise<void> {
    ...
    try {
      const newImages: any[] = await Promise.all(promises); // Asume que newImages es una matriz de cualquier tipo, ya que no proporcionaste información sobre su tipo.

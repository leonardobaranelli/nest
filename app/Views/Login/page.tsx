...
const Login : React.FC = () => {
  ...
  const handleLogin: MouseEventHandler<HTMLButtonElement> = async (event) => {
    ...
    try {
      // Llamar a la función signIn para iniciar sesión con las credenciales proporcionadas
        ...
        <div className="mx-auto max-w-lg text-center">
            ...
            <form className="space-y-4 max-w-md mx-auto mt-8">
              ...
              <div className="flex justify-center items-center">
                <a
                  ...
                  className="flex justify-center items-center mt-5 border rounded-3xl"
                >
                  <svg
          ...
          {loginError && (
            <p className="text-red-500">
              Error en el inicio de sesión: {loginError}
            </p>
          )}
        </div>
      </div>
